 ...
 *
 * The recommended way of creation is to use one of {@link CachedValuesManager} methods, e.g.
 * {@link CachedValuesManager#getCachedValue(com.intellij.psi.PsiElement, CachedValueProvider)}
 *
